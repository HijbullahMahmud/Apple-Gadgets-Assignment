...
import 'package:apple_gadgets_assignment/app/views/trade/trade_list_screen.dart';

class Routes {
  static const String splashScreen = "/splash_screen";
  static const String authScreen = "/auth_screen";
  static const String profileScreen = "/profile_screen";
  static const String tradeListScreen = "/trade_list_screen";

  static var list = {
    Routes.splashScreen: (context) => SplashScreen(),
    Routes.authScreen: (context) => const AuthScreen(),
    Routes.profileScreen: (context) => const ProfileScreen(),
    Routes.tradeListScreen: (context) => const TradeListScreen(),
  };
}
